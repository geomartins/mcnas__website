...
@section("title")
  ...
  {{ config("app.name") }}  | Mobile App Development

@endsection

@section("breadcrumb")
    @includeIf("layouts.breadcrumb", ["title" => "Mobile App Development" , "subtitle" => "Mobile App Development"])
@endsection
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="ttm_single_image-wrapper text-right">
                        <img class="img-fluid" src="images/single-product/single-mobile-development.jpg" alt="">
                    </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                         <div class="twentytwenty-container">
                            <img src="images/category-product/mobile_1.jpg" alt="before" >
                            <img src="images/category-product/mobile_1.jpg" alt="after" >
                        </div>
                </div>
                <div class="col-md-4 col-sm-4">
                         <div class="twentytwenty-container">
                            <img src="images/category-product/mobile_2.jpg" alt="before" >
                            <img src="images/category-product/mobile_2.jpg" alt="after" >
                        </div>
                </div>
                <div class="col-md-4 col-sm-4">
                         <div class="twentytwenty-container">
                            <img src="images/category-product/mobile_3.jpg" alt="before" >
                            <img src="images/category-product/mobile_3.jpg" alt="after" >
                        </div>
                </div>
            </div>
        </div>
