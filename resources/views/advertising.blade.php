                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                        <div class="p-20 bg-white">
                          <img src="images/category-product/advertising_1.jpg" alt="">
                        </div>
                      </div>
          
                      <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                        <div class="p-20 bg-white">
                          <img src="images/category-product/advertising_2.jpg" alt="">
                        </div>
                      </div>
          
                      <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                        <div class="p-20 bg-white">
                          <img src="images/category-product/advertising_3.jpg" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
