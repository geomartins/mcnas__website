            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="ttm_single_image-wrapper text-right">
                        <img class="img-fluid" src="images/single-product/single-machine.jpg" alt="">
                    </div>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="ttm_single_image-wrapper res-575-mb-15">
                         <div class="twentytwenty-container">
                            <img src="images/category-product/machine_1.jpg" alt="before" >
                            <img src="images/category-product/machine_1.jpg" alt="after" >
                        </div>
                    </div><!-- ttm_single_image-wrapper end -->
                </div>
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="ttm_single_image-wrapper res-575-mb-15">
                         <div class="twentytwenty-container">
                            <img src="images/category-product/machine_2.jpg" alt="before" >
                            <img src="images/category-product/machine_2.jpg" alt="after" >
                        </div>
                    </div><!-- ttm_single_image-wrapper end -->
                </div>
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="ttm_single_image-wrapper">
                         <div class="twentytwenty-container">
                            <img src="images/category-product/machine_3.jpg" alt="before" >
                            <img src="images/category-product/machine_3.jpg" alt="after" >
                        </div>
                    </div><!-- ttm_single_image-wrapper end -->
                </div>
            </div>
