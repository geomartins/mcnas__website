...
@section("title")
  ...
  {{ config("app.name") }}  | Distinctive Award
@endsection

@section("breadcrumb")
    @includeIf("layouts.breadcrumb", ["title" => "Distinctive Award" , "subtitle" => "Distinctive Award"])
@endsection
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xs-12">
                    ...
                    <div class="ttm_single_image-wrapper text-right">
                        <img class="img-fluid" src="images/single-product/single-award.jpg" alt="">
                    </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                        <div class="p-20 bg-white">
                          <img src="images/category-product/award_1.jpg" alt="">
                        </div>
                      </div>
          
                      <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                        <div class="p-20 bg-white">
                          <img src="images/category-product/award_2.jpg" alt="">
                        </div>
                      </div>
          
                      <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                        <div class="p-20 bg-white">
                          <img src="images/category-product/award_3.jpg" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
