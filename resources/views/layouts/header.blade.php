                ...
                <div class="container">
                    <div class="ttm-topbar-content">
                        <ul class="top-contact text-left">
                            ...
                            <li><i class="themifyicon ti-timer"></i>Mon - Sat 8.00 - 18.00.</li>
                        </ul>
                        <div class="topbar-right text-right">
                            <ul class="top-contact text-right pr-10">
                                <li><i class="themifyicon ti-email"></i>Email: <a href="mailto:info@example.com.com">info@example.com</a></li>
                                <li><i class="themifyicon ti-mobile"></i>Call: 123 456 78910</li>
                            </ul>
                ...
                <div class="container">
                    <div class="ttm-header-top-wrapper clearfix">
                        ...
                        <div class="ttm-content-wrapper">
                            ...
                            <div class="header-widget">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="#">GET APPOINTMENT!</a>
                            </div>
                                           ...
                                           <li class="active"><a href="index.html">Home</a>
                                                <ul>
                                                    ...
                                                    <li><a href="#">Header Styles</a>
                                                        <ul>
                                                            <li><a href="index.html">Header Classic Info</a></li>
